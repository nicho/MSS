...
<script type="text/javascript">
		...
		function functionsClick() {
			...
			mydtree.openTo($("#menuNodeId").val(),$("#menuNodeId").val(),0);
	...
	<body>
		<form class="form-search" action="${ctx}/updateResource.do" id="inputForm">
							...
							<div class="span12">
								<ul>
									<li class="rgcont_li">
										...
										<div class="rgcont_rr">
											<input type="text" class="input1 required" readonly="readonly" name="resourceCode"
												id="resourceCode" value="${resource.resourceCode}"/>
										</div>
									</li>
									<li class="rgcont_li">
										<div class="rgcont_wz">
									...
									<li class="rgcont_li">
										...
										<div class="rgcont_rr">
											<input type="text" class="input1 required" name="resourceDesc"
												id="resourceDesc"  value="${resource.resourceDesc}"/>
										</div>
									</li>
									<li class="rgcont_li">
										<div class="rgcont_wz">
										...
										<div class="rgcont_rr">
											<input type="text" class="input1 required" name="menuNodeName"
												id="menuNodeName" onclick="functionsClick();" value="${resource.menuNodeName}"/> 
											<input type="hidden" class="input1 required" name="menuNodeId"
												id="menuNodeId" value="${resource.menuNodeId}" />
