	...
	<body>
		...
		<div style="overflow: auto" id="area-overflow">
			<div class="main-box" id="area-right">
				<form id="inputForm" action="${ctx}/updateResponsibility.do"
					...
					<fieldset>
								...
								<tr>
									...
									<td class="text_lf">
										<input type="text" class="input1"
											id="responsibilityName" name="responsibilityName" value="${responsibilityDto.responsibilityName}" />
									</td>
									<td class="text_rg title_font bzh">
										职责编码
									</td>
									<td class="text_lf">
										<input type="text" class="input1" readonly="readonly"
											id="responsibilityCode" name="responsibilityCode" value="${responsibilityDto.responsibilityCode}" />
									...
									<td class="text_lf">
										<input type="text" class="input1"
											id="responsibilityDesc" name="responsibilityDesc" value="${responsibilityDto.responsibilityDesc}" />
									</td>
								</tr>
								<tr>
									<td class="text_rg title_font bzh">
									...
									<td class="text_lf">
										<input type="text" class="input1 input-large required" value="${responsibilityDto.beginDate}" name="beginDate" id="beginDate" onClick="WdatePicker()"/>
									</td>
									<td class="text_rg title_font bzh">
										失效日期
									</td>
									<td class="text_lf">
										<input type="text" class="input1 input-large" value="${responsibilityDto.endDate}" name="endDate" id="endDate" onClick="WdatePicker()"/>		
									</td>
									<td class="text_rg title_font bzh">
									</td>
									<td class="text_lf">
							...
							<table id="contentTable_profiles"
								...
								<c:forEach var="profile"  items="${Resprofiles}" varStatus="vstatus">
									<tr class="tbth ">
										<td>
							           	 	${profile.profileName}
							           	 	<input type="hidden" name="profileIds" value="${profile.profileId}"/>
							           	</td>
							           	<td>
											${profile.profileCode}
										</td>
										...
										<td>
											<oaTag:profileSelect url="gotoResponsibilityList.do"
												profileName="${profile.profileCode}" name="profileVals"
									...
									<tr class="tbth ">
										<td width="30%">
									           ...
									           <c:forEach var="responsibilityInvList"  items="${responsibilityInvList}" varStatus="vstatus">
									           		<option value="${responsibilityInvList.invOrganizationId}" <c:if test='${invList.invOrganizationId eq responsibilityInvList.invOrganizationId}'>selected</c:if>>${responsibilityInvList.invOrganizationName}</option>
									           </c:forEach>
									        </select>
							           	</td>
							           	<td>
						...
						<div class="dbzn ">
							...
							<input id="cancel_btn" class="btn buttom1" type="button"
								value="<spring:message code='Cancel'/>" onClick="location.href='gotoResponsibilityList.do'" />
						</div>
					</fieldset>
				</form>
			</div>
