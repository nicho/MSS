...
<script type="text/javascript">
	...
	function btn_click(personId,departmentCode,departmentName,positionId,positionName,jobId,orgId,orgName){
		parent.personSet(personId,departmentCode,departmentName,positionId,positionName,jobId,orgId,orgName);
		parent.closeDialog();
	}
</script>
<style>
	    	...
	    	<div class="table_auto scroll_auto" style="overflow-x:auto;overflow-y:hidden;">
		 		<table id="contentTable" width="90%" class="table table-striped table-bordered table-condensed table-hover ">
			    	...
			    	<c:forEach var="list"  items="${list}" varStatus="vstatus">
				    	<tr>
				    		<td>
						     <a onclick="btn_click('${list.personId}','${list.departmentCode}','${list.departmentName}','${list.positionId}','${list.positionName}','${list.jobId}','${list.orgId}','${list.orgName}')">选择</a>
						    </td>
