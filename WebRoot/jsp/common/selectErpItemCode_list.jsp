...
<script type="text/javascript">
	...
	function btn_click(itemcode){
		parent.samplingWipSetItemCode(itemcode);
		parent.closeDialog2();
	}
</script>
<style>
...
<body style="border: 0px; overflow: auto; height: 400px;">
	<form id='searchForm' class="form-search" action="${ctx}/gotoSelectErpItemCode.do">

		<div class="add_top">&nbsp;&nbsp;&nbsp;●&nbsp;&nbsp;产成品选择</div>
		<!--搜索部分begin-->
		<div class="row-fluid aufour mar_2">
			...
			<table class="tableopen" width="100%">
				<tr>
					...
					<td class="text_lf"><input type="text" class="open_srk  " name="item_code" id="item_code" value="${param.item_code}">
					<td class="text_rg title_font bzh ">产品名称</td>
					<td class="text_lf"><input type="text" class="open_srk  " name="item_name" id="item_name" value="${param.item_name}"></td>
				</tr>
			</table>
		...
		<div class="row-fluid aufive mar_2">
			...
			<div class="table_auto scroll_auto" style="overflow-x: auto; overflow-y: hidden;">
				<table id="contentTable" width="90%" class="table table-striped table-bordered table-condensed table-hover ">
					...
					<c:forEach var="list" items="${erpItemCodeList}" varStatus="vstatus">
						<tr>
							<td><a onclick="btn_click('${list.item_code}')">选择</a></td>
